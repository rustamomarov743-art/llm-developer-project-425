...
"$YC" serverless function version create \
    ...
    --source-path "$ARCHIVE" \
    --format json \
    --environment YC_FOLDER_ID="$FOLDER_ID",YC_AGENT_ID="$AGENT_ID",YC_YDB_TICKETS_MCP_SERVER_URL="$MCP_SERVER_URL",IMAP_HOST="imap.gmail.com",IMAP_PORT="993",IMAP_USER="llm.developer.project.425@gmail.com",SMTP_HOST="smtp.gmail.com",SMTP_PORT="587",SMTP_USER="llm.developer.project.425@gmail.com",HELPDESK_MAILBOX="llm.developer.project.425@gmail.com" \
